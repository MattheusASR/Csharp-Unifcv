...
namespace aula_4.Controllers
{
    public class CursosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CursoID,Nome,CargaHoraria")] Curso curso)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CursoID,Nome,CargaHoraria")] Curso curso)
        {
            if (ModelState.IsValid)
            {
